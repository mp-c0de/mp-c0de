...
- 🔹 SwiftData persistence with custom transformers
- 🔹 Real-time chart visualization

**Tech Stack:** SwiftUI, CoreBluetooth, SwiftData, Charts, MVVM
...
**Tech Stack:** SwiftUI, Stripe SDK, JWT, Keychain, RESTful APIs
...
- 🔹 Manager dashboard with employee wizard
- 🔹 Demonstrates scalable hospitality/POS architecture

**Tech Stack:** SwiftUI, SwiftData, Timeline Views, MVVM
...
**Tech Stack:** SwiftUI, Google Gemini API, Combine, Server-Sent Events
...
**Tech Stack:** SwiftUI, URLSession, Async/Await, MVVM
...
- 🔹 StoreKit integration for donations
- 🔹 Comprehensive member tracking system

**Tech Stack:** SwiftUI, SwiftData, PhotosUI, StoreKit
...
<div align="center">
  ...
  ![GitHub Stats](https://github-readme-stats.vercel.app/api?username=mp-c0de&show_icons=true&theme=radical&hide_border=true&count_private=true)

  ![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=mp-c0de&layout=compact&theme=radical&hide_border=true&langs_count=8)
...
**BSc Computer Science** | University of Greenwich | *2023 - 2026*
- Final Year Project: Casino Staff Holiday Scheduling System (SwiftUI, SwiftData)
- Core modules: OOP, Data Structures & Algorithms, Web Development, Operating Systems, Databases
- Group projects with Azure DevOps, AWS Lightsail deployment, collaborative Git workflows

---

## 💼 Professional Background

**Casino Dealer** | The Grosvenor Victoria Casino, London | *May 2016 - Present*

**Pit Boss (Gaming Supervisor)** | UAB Egivela Casinos, Lithuania | *2008 - 2009*

**17 years total experience** in fast-paced hospitality and gaming operations, with deep understanding of:
- POS and transactional systems
- Regulatory compliance and financial accuracy
- Customer service excellence under pressure
- Team collaboration in live event environments

This unique combination of hospitality domain expertise and iOS development skills makes me particularly effective at building solutions for the hospitality, POS, and service industries.
